    ...
    {{--Sidebar--}}
        <div class="fixed left-0">
            <div class="w-70 bg-white h-screen px-8 py-10 rounded-r-[20px] shadow-lg">
                <img src="{{ asset('img/logo2.png') }}" alt="" class="h-[100px] w-auto px-14">
                <div class="mt-[30px] h-full grid grid-flow-row list">
                    
                    {{--Sidebar Atas--}}
                    <div class="flex flex-col row-span-2 space-y-5 sublist">
                        <a href="{{url('')}}/{{Auth::user()->type}}/dashboard" class="no-underline border-[1px] border-cyan-400 px-4 py-2 rounded-full <?= ((request()->segment(2) == 'dashboard')|| (request()->segment(1) == 'home'))?'text-white bg-cyan-400 hover:bg-cyan-600 ':'text-cyan-400 hover:text-white hover:bg-cyan-400 ';?>">
                        ...
                        <a href="{{url('')}}/{{Auth::user()->type}}/klinik" class="no-underline border-[1px] border-cyan-400 px-4 py-2 rounded-full <?= (in_array(request()->segment(2),['klinik','add_agenda']))?'text-white bg-cyan-400 hover:bg-cyan-600':'text-cyan-400 hover:text-white hover:bg-cyan-400 ';?>">
                            <div class="flex items-center">
                        ...
                        <a href="{{url('')}}/{{Auth::user()->type}}/log" class="no-underline border-[1px] border-cyan-400 px-4 py-2 rounded-full   <?= (request()->segment(2) == 'log')?'text-white bg-cyan-400 hover:bg-cyan-600':'text-cyan-400 hover:text-white hover:bg-cyan-400 ';?>">
                            <div class="flex items-center">
                                <i class='bx bx-history bx-sm'></i>
                                <span class=" pl-2 pb-[2px] capitalize text-md">catatan</span>
                            </div>
                        </a>
                        <a href="{{url('')}}/{{Auth::user()->type}}/klinik" class="no-underline border-[1px] border-cyan-400 px-4 py-2 rounded-full  <?= ((in_array(request()->segment(2),['klinik'])) || (request()->segment(3) == 'show_agenda'))?'text-white bg-cyan-400 hover:bg-cyan-600':'text-cyan-400 hover:text-white hover:bg-cyan-400 ';?>">
                            <div class="flex items-center">
                                <i class='bx bxs-calendar-plus bx-sm'></i>
                                <span class=" pl-2 pb-[2px] capitalize text-md">jadwal aktivitas</span>
                            </div>
                    ...
                    <div class="flex flex-col bottom-0 mb-20">
                        <a href="{{ route('profile',Auth::user()->id) }}" class="no-underline border-[1px] border-cyan-400 px-4 py-2 rounded-full <?= (request()->segment(1) == 'akun')?'text-white bg-cyan-400 hover:bg-cyan-600':'text-cyan-400 hover:text-white hover:bg-cyan-400 ';?>">
