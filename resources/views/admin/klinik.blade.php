        ...
        <div class="w-full pb-10">
            <div class="w-full rounded-[10px] bg-white p-5">
                <div class="mx-auto max-w-xl text-center">
                    <h2 class="my-2 text-3xl font-extrabold tracking-tight text-slate-900 md:text-3xl">Kalendar Aktivitas</h2>
                </div>
                <div class="mx-auto lg:w-full my-6">
                    ...
                    <div class="flex flex-warp justify-center w-full px-6 mt-4 mb-6">
                        <div class="col pl-1 font-semibold text-slate-900 text-lg">Tambah Agenda:</div>
                        <div class="col pl-4">
                            <a href="{{url('')}}/{{Auth::user()->type}}/add_agenda" class="text-white bg-cyan-400 hover:bg-cyan-600 focus:ring-4 focus:ring-purple-300 font-medium rounded-md text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Tambah</a>
                        </div>
                    </div>
                    <div class="w-full px-6">
                        <div class="py-2 border border-l-0 border-r-0 text-center">
                            <div class="pl-1 font-semibold text-slate-900 text-lg">Detail Aktivitas</div>
                        </div>
