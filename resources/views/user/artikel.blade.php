...
@section('container')
    <div class="h-screen w-full px-16 py-16">
        <div class="flex flex-warp gap-4">
            ...
            <a href="{{url('')}}/add_article" class="w-[15%] h-auto px-4 py-2 focus:outline-cyan-400 bg-white rounded-xl capitalize appearance-none hover:bg-cyan-400 hover:text-white"><span class="bx bx-plus"></span> upload</a>
        </div>
